...
open -a /Applications/Firefox.app \
  ...
  https://github.com/stevector/wordpress-higher-ed-demo/blob/master/wp-content/themes/twentyseventeen/template-parts/header/site-branding.php \
  ...
  https://circleci.com/gh/stevector/wordpress-higher-ed-demo \
