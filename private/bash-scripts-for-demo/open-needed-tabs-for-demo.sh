...
open -a /Applications/Firefox.app \
    ...
    https://live-hed-anthropology.pantheonsite.io/?refresh-favicon=true \
    https://live-hed-ee.pantheonsite.io/?refresh-favicon=true \
    https://live-hed-creative-writing.pantheonsite.io/?refresh-favicon=true \
